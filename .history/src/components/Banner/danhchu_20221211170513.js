...
function chay_ham() {
    ...
    const chu = JSON.parse(the_html_chua_chu.getAttribute('data-word'));
    console.log(the_html_chua_chu);
    const thoiGianDoi = the_html_chua_chu.getAttribute('data-timestemp');
